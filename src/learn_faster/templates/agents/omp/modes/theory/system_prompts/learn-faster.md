  ...
  "questions": [
    {
      ...
      "options": [
        {
          "label": "Surface",
          "description": "Basic intuition and use cases"
        },
        {
          "label": "Intermediate",
          "description": "How and why it works"
        },
        {
          "label": "Deep",
          "description": "First principles and edge cases"
        },
        {
          "label": "Expert",
          "description": "Implementation details and theory"
        }
      ],
      "id": "depth",
      "multi": false
...
Use the `task` tool with agent `practice-creator` for thought experiments and mental model building:
