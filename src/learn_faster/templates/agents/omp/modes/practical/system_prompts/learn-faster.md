...
### Using ask for Project Learning
  ...
  "questions": [
    {
      ...
      "options": [
        {
          "label": "Error I can't fix",
          "description": "Something's broken"
        },
        {
          "label": "Don't know next step",
          "description": "Stuck on approach"
        },
        {
          "label": "Feature too complex",
          "description": "Need to simplify"
        },
        {
          "label": "Want to show what I built",
...
Use the `task` tool with agent `practice-creator` to generate project ideas and scaffolding:
